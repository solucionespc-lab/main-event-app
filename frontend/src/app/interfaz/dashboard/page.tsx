...
import { Home, UserPlus, Calendar, BarChart2, CreditCard, HelpCircle, Menu, ShoppingBag } from 'lucide-react'
          ...
          <ul className="pt-2 pb-4 space-y-1 text-sm">
            {sidebarItems.map((item, index) => (
              <li key={index} className="rounded-sm">
                <Link to={item.href} className="flex items-center p-2 space-x-3 rounded-md hover:bg-gray-800">
